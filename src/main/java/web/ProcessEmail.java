...
//        System.out.println("Finished checking inbox");
    ...
    public void completeRequest(Address[] address, String result, Map<String, Attributes> final_obj, String filename) {
        ...
        try {
            ...
            Attributes attr = final_obj.get(filename);
            ...
            html_raw = html_raw.replace("programmingLanguagesValue", attr.getLanguage().toString());
